...
pf_test_t suite_overflow[] = {
    { &test_overflow_int, "/overflow/int" },
    { &test_overflow_long, "/overflow/long" },
    { &test_overflow_llong, "/overflow/llong" },
    { &test_overflow_int32, "/overflow/int32" },
    { &test_overflow_int64, "/overflow/int64" },
    { &test_overflow_intmax, "/overflow/intmax" },
    { &test_overflow_intptr, "/overflow/intptr" },
    { &test_overflow_ptrdiff, "/overflow/ptrdiff" },
    { &test_overflow_uint, "/overflow/uint" },
    { &test_overflow_ulong, "/overflow/ulong" },
    { &test_overflow_ullong, "/overflow/ullong" },
    { &test_overflow_uint32, "/overflow/uint32" },
    { &test_overflow_uint64, "/overflow/uint64" },
    { &test_overflow_uintmax, "/overflow/uintmax" },
    { &test_overflow_uintptr, "/overflow/uintptr" },
    { &test_overflow_size, "/overflow/size_t" },

    { &test_saturated_int, "/saturated/int" },
    { &test_saturated_long, "/saturated/long" },
    { &test_saturated_llong, "/saturated/llong" },
    { &test_saturated_int32, "/saturated/int32" },
    { &test_saturated_int64, "/saturated/int64" },
    { &test_saturated_intmax, "/saturated/intmax" },
    { &test_saturated_intptr, "/saturated/intptr" },
    { &test_saturated_ptrdiff, "/saturated/ptrdiff" },
    { &test_saturated_uint, "/saturated/uint" },
    { &test_saturated_ulong, "/saturated/ulong" },
    { &test_saturated_ullong, "/saturated/ullong" },
    { &test_saturated_uint32, "/saturated/uint32" },
    { &test_saturated_uint64, "/saturated/uint64" },
    { &test_saturated_uintmax, "/saturated/uintmax" },
    { &test_saturated_uintptr, "/saturated/uintptr" },
    { &test_saturated_size, "/saturated/size_t" },
    { 0 },
};
